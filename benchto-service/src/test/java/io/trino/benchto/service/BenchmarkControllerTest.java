        ...
        extends IntegrationTestBase
{
            ...
            throws Exception
    {
        ...
        ZonedDateTime testStart = TimeUtils.currentDateTime();
        ...
        Instant executionFinish = TimeUtils.currentDateTime().toInstant();
        ...
        if (reportRunFinishBeforeBenchmarkFinish) {
            ...
            testEnd = TimeUtils.currentDateTime();
        }
        else {
            reportBenchmarkFinish.call();
            testEnd = TimeUtils.currentDateTime();
        ...
        withinTransaction(() -> {
            ...
            assertThat(benchmarkRun.getStatus()).isEqualTo(Status.ENDED);
            assertThat(benchmarkRun.getMeasurements())
                    .hasSize(2)
                    .extracting("unit").contains(MeasurementUnit.BYTES, MeasurementUnit.MILLISECONDS);
