...

{
    ...
    public void testBuilder_successful_run()
    {
        Benchmark benchmark = new Benchmark.BenchmarkBuilder("name", "sequenceId", emptyList())
                ...
                .build();
        BenchmarkExecutionResult.BenchmarkExecutionResultBuilder builder = new BenchmarkExecutionResult.BenchmarkExecutionResultBuilder(benchmark);

        builder.startTimer();
        TimeUtils.sleep(500, MILLISECONDS);
        builder.endTimer();
